...
from erp.models import Sale, Product, DetSale, Activity, ActivityAnimal
...
class DashboardView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['pending_activities'] = pending_activities
        pending_activities_animal = ActivityAnimal.objects.filter(status="pending")
        context['pending_activities_animal'] = pending_activities_animal
        context['pending_count'] = pending_activities.count() + pending_activities_animal.count()
        return context
